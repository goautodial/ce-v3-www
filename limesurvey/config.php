...
$databaseuser       =   'goautodialu';        // The name of a user with rights to create db (or if db already exists, then rights within that db)
$databasepass       =   'pancit888';            // Password of db user
