...
function getLanguageNameFromCode($codetosearch, $withnative=true,$clang)
{
    $detaillanguages = getLanguageData(false,$clang);
 ...
 *
 */
function getLanguageDetails($codetosearch,$clang)
{
    $detaillanguages = getLanguageData(null,$clang);
...
function getLanguageData($orderbynative=false,$clang) {
    #global $clang;
