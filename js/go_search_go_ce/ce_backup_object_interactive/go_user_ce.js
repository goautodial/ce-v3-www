...
$(function (){
    ...
    $('div.ungroup-toggle').click(function (){
        ...
        $("#"+$group).slideToggle("fast",function(){
              ...
              /*$.ajax({
                      type: "GET",
                      url: protocol+"//"+host+"/index.php/go_user_ce/collectuserinfo/"+$("#vicidial_user_id-"+$userid).val(),
                      async: false,
                      datatype : 'jsonp',
                      success: 
              });*/
        ...
        if($action.toLowerCase() == 'update'){
            $("#form-"+$group).validate({
                   submitHandler: function(form){
                       if($(this).valid){
                             $.post(
                                    protocol+"//"+host+"/index.php/go_user_ce/updateuser/"+$('#vicidial_user_id-'+$group).val()+"/"+$("#users_id-"+$group).val(),
            ...
            if(confirm("Do you really want to disable this agent?")){
                 $.post(
                        protocol+"//"+host+"/index.php/go_user_ce/deleteuser/"+$('#vicidial_user_id-'+$group).val()+"/"+$("#users_id-"+$group).val(),
                        $("#form-"+$group).serialize(),
                        function (data){
