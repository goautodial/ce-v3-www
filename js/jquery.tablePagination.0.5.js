 ...
 */
 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
      ...
      if (numRows > defaults.rowsPerPage || defaults.rowsPerPage == "ALL")
      {
	    var hideThis = '';
		var hideThisOne = '';
		if (defaults.rowsPerPage == "ALL") {
			hideThisOne = ' style="display:none;"';
		}
      }
      else
      {
      ...
      function createPaginationElements() {
        ...
        htmlBuffer.push("<span id='tablePagination_paginater'"+hideThisOne+">");
