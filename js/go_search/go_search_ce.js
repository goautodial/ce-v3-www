...
$(function (){
    ...
    $('#tab-nav').tabs({
        ...
        ajaxOptions:{
              data:{userid:passtophp,search:searchpass,type:passtype},
              type: "POST",
              cache: false,
        },
         ...
         if($(this).attr('id').indexOf('action-modify') !== -1){
              ...
              $('.wizard-box-modify').children().each(function(){
                    if($(this).is('form')){
                         ...
                         $.post(
                               protocol+"//"+host+"/index.php/go_search_ce/collectuserinfo/"+$viciId,
                               function(data){
                                  $.each(data,function(){
              ...
              if(confirm("Do you really want to disable this agent?")){
                     ...
                     $.post(
                           protocol+"//"+host+"/index.php/go_search_ce/deleteuser/"+$post.users_id+"/"+$post.vicidial_user_id,
                           function (data){
                                alert(data);
             ...
             $url = "http://recordings.goautodial.com/RECORDINGS/2012-09-18/20120918-101545_2158441038_87808_13_878087_005-all.mp3"; 

             $("#download").load(protocol+"//"+host+"/index.php/go_search_ce/download"
        ...
        if($(this).attr('id').indexOf('save') !== -1){
            ...
            $($form).validate({
                    submitHandler: function(form){
                         if(this.valid()){
                                 $.post(
                                          protocol+"//"+host+'/index.php/go_search_ce/updateuser/'+$user_id+"/"+$user,
                                          $posts,
                                          function(data){
                                              alert(data);
                                          }
...
$(function(){
    ...
    $(".user-batch-action").delegate('a','click',function(){
         ...
         if($batch.length > 0){
              $.post(
                     protocol+'//'+host+'/index.php/go_search_ce/batchupdate/',
                     {users:$users},
                     function(data){
...
$(function(){
     ...
     $(".user-tbl-cols").delegate("a.search_leadinfo","click",function(){
          ...
          $.post(
                 ...
                 function (data){
                     ...
                     if(data.indexOf("Error") === -1){
                        ...
                        $("#leadinfo_comments").empty().append($result[0].comments);
...
function leadinfo(leadid){
    ...
    $("#calls-to-this-lead").find("div.user-tbl-container").empty().load(protocol+'//'+host+'/index.php/go_search_ce/calls/'+leadid);
    $("#closer-records").find("div.user-tbl-container").empty().load(protocol+'//'+host+'/index.php/go_search_ce/closerlog/'+leadid);
    $("#agent-log").find("div.user-tbl-container").empty().load(protocol+'//'+host+'/index.php/go_search_ce/agentlog/'+leadid);
    $("#recording").find("div.user-tbl-container").empty().load(protocol+'//'+host+'/index.php/go_search_ce/leadrecord/'+leadid);
