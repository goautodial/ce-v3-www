...
function html_hardware () {
	...
	for( $i = 1, $max = sizeof( $XPath->getDataParts( "/phpsysinfo/Hardware/PCI" ) ); $i < $max; $i++ ) {
		if( $XPath->match( "/phpsysinfo/Hardware/PCI/Device[" . $i . "]/Name" ) ) {
			$strPcidevices .= "<tr><td valign=\"top\">-</font></td><td>" . $XPath->getData( "/phpsysinfo/Hardware/PCI/Device[" . $i . "]/Name" ) . "</font></td></tr>";
		}
	}
	
	for( $i = 1, $max = sizeof( $XPath->getDataParts( "/phpsysinfo/Hardware/IDE" ) ); $i < $max; $i++ ) {
		if( $XPath->match( "/phpsysinfo/Hardware/IDE/Device[" . $i . "]" ) ) {
			$strIdedevices .= "<tr><td valign=\"top\">-</font></td><td>" . $XPath->getData( "/phpsysinfo/Hardware/IDE/Device[" . $i . "]/Name" );
	...
	for( $i = 1, $max = sizeof( $XPath->getDataParts( "/phpsysinfo/Hardware/SCSI" ) ); $i < $max; $i++ ) {
		if( $XPath->match( "/phpsysinfo/Hardware/SCSI/Device[" . $i . "]" ) ) {
			$strScsidevices .= "<tr><td valign=\"top\">-</font></td><td>" . $XPath->getData( "/phpsysinfo/Hardware/SCSI/Device[" . $i . "]/Name" );
	...
	for( $i = 1, $max = sizeof( $XPath->getDataParts( "/phpsysinfo/Hardware/USB" ) ); $i < $max; $i++ ) {
		if( $XPath->match( "/phpsysinfo/Hardware/USB/Device[" . $i . "]/Name" )) {
			$strUsbdevices .= "<tr><td valign=\"top\">-</font></td><td>" . $XPath->getData( "/phpsysinfo/Hardware/USB/Device[" . $i . "]/Name" ) . "</font></td></tr>";
		}
	}
	
	$_text = "<table border=\"0\" width=\"100%\" align=\"center\">\n";
	if( $XPath->match( "/phpsysinfo/Hardware/CPU/Number" ) ) {
		$_text .= "  <tr>\n    <td class=\"tabdata\" valign=\"top\">" . $text['numcpu'] . "</font></td>\n    <td class=\"tabdata\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" . $XPath->getData( "/phpsysinfo/Hardware/CPU/Number" ) . "</font></td>\n   </tr>\n";
	} 
	if( $XPath->match( "/phpsysinfo/Hardware/CPU/Model" ) ) {
		$_text .= "  <tr>\n    <td class=\"tabdata\" valign=\"top\">" . $text['cpumodel'] . "</font></td>\n    <td class=\"tabdata\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" . $XPath->getData( "/phpsysinfo/Hardware/CPU/Model" );
	...
	if( $XPath->match( "/phpsysinfo/Hardware/CPU/Cpuspeed" ) ) {
		$_text .= "  <tr>\n    <td class=\"tabdata\" valign=\"top\">" . $text['cpuspeed'] . "</font></td>\n    <td class=\"tabdata\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" . format_speed( $XPath->getData( "/phpsysinfo/Hardware/CPU/Cpuspeed" ) ) . "</font></td>\n  </tr>\n";
	}
